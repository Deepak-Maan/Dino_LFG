        ...
        <div id="faq" className="relative">
            <div className="max-w-[1140px] mx-auto px-3  lg:pt-[310px] md:pt-[200px] sm:pt-[150px] pt-[100px]">
                ...
                <div data-aos-delay="400" data-aos="zoom-in" className=" mx-auto relative max-w-[800px] px-2 ">
                    <Accordion className={`border-[#C5C5C5] border bg-[#09655A] mb-4 rounded-full p-3 sm:pt-[30px] sm:pb-[27px] sm:ps-[26px] ${open === 1 ? 'rounded-[26px] sm:rounded-[45px] ' : 'rounded-full'}`} open={open === 1} icon={<Icon id={1} open={open} />}                >
                    ...
                    <Accordion className={`border-[#C5C5C5] border bg-[#09655A] mb-4 overflow-hidden rounded-full p-3 sm:pt-[30px] sm:pb-[27px] sm:ps-[26px] ${open === 2 ? 'rounded-[26px] sm:rounded-[45px]' : 'rounded-full'}`} open={open === 2} icon={<Icon id={2} open={open} />} >
                    ...
                    <Accordion className={`border-[#C5C5C5] border bg-[#09655A] mb-4 rounded-full p-3 sm:pt-[30px] sm:pb-[27px] sm:ps-[26px] ${open === 3 ? 'rounded-[26px] sm:rounded-[45px]' : 'rounded-full'}`} open={open === 3} icon={<Icon id={3} open={open} />}>
                    ...
                    <Accordion className={`border-[#C5C5C5] border bg-[#09655A] mb-4 rounded-full p-3 sm:pt-[30px] sm:pb-[27px] sm:ps-[26px] ${open === 4 ? 'rounded-[26px] sm:rounded-[45px]' : 'rounded-full'}`} open={open === 4} icon={<Icon id={4} open={open} />}>
                    ...
                    <Accordion className={`border-[#C5C5C5] border bg-[#09655A] mb-4 rounded-full p-3 sm:pt-[30px] sm:pb-[27px] sm:ps-[26px] ${open === 5 ? 'rounded-[26px] sm:rounded-[45px]' : 'rounded-full'}`} open={open === 5} icon={<Icon id={5} open={open} />}>

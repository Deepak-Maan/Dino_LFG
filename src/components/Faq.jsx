...
function Icon({ id, open }) {
    return (
        <div className="relative ">
            <svg className={`${id === open ? "rotate-180" : "rotate-0"} mr-12   transition-transform`} width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div id="faq" className="relative">
            <div className="max-w-[1140px] mx-auto px-3  lg:pt-[310px] md:pt-[200px] sm:pt-[150px] pt-[100px]">
                ...
                <div className=" mx-auto relative max-w-[800px] px-2 ">
                    <Accordion className={`border-[#C5C5C5] border mb-4 rounded-full pt-[30px] pb-[27px] ps-[26px] ${open === 1 ? 'rounded-[45px] ' : 'rounded-full'}`} open={open === 1} icon={<Icon id={1} open={open} />}                >
                    ...
                    <Accordion className={`border-[#C5C5C5] border mb-4 overflow-hidden rounded-full pt-[30px] pb-[27px] ps-[26px] ${open === 2 ? 'rounded-[45px] ' : 'rounded-full'}`} open={open === 2} icon={<Icon id={2} open={open} />} >
                    ...
                    <Accordion className={`border-[#C5C5C5] border mb-4 rounded-full pt-[30px] pb-[27px] ps-[26px] ${open === 3 ? 'rounded-[45px] ' : 'rounded-full'}`} open={open === 3} icon={<Icon id={3} open={open} />}>
                    ...
                    <Accordion className={`border-[#C5C5C5] border mb-4 rounded-full pt-[30px] pb-[27px] ps-[26px] ${open === 4 ? 'rounded-[45px] ' : 'rounded-full'}`} open={open === 4} icon={<Icon id={4} open={open} />}>
                    ...
                    <Accordion className={`border-[#C5C5C5] border mb-4 rounded-full pt-[30px] pb-[27px] ps-[26px] ${open === 5 ? 'rounded-[45px] ' : 'rounded-full'}`} open={open === 5} icon={<Icon id={5} open={open} />}>

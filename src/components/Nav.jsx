...
const NavBar = () => {
    ...
    return (
        <div className='max-w-[1140px] mx-auto px-3 pt-7 relative z-10'>
            <div className='flex justify-between items-center py-[10px] lg:pt-[4px] lg:pb-[5.50px] pl-[24px] pr-[7.42px] bg-white rounded-[61.102px] border-b-[4px] border-solid border-black'>
                ...
                <div className='flex gap-[136px] items-center'>
                    <ul className={`${nav ? "left-[-100%]" : "left-0"} flex max-lg:fixed gap-[28px] max-lg:z-50 items-center max-lg:top-0 max-lg:h-full max-lg:w-full max-lg:bg-white max-lg:transition-all max-lg:duration-300 max-lg:ease-linear max-lg:min-h-screen max-lg:flex-col max-lg:justify-center`}>
                        <li><a href="#About" aria-label="openNav" onClick={() => setNav(!nav)} className='font-chewy text-[18px] font-normal text-black no-underline leading-[100%] after:absolute after:bottom-[-4px] after:left-[50%] after:w-0 after:bg-black after:h-[3px] hover:after:w-full relative after:right-0 hover:after:left-0 after:transition-all after:duration-300 after:rounded-[5px] after:ease-linear'>About</a></li>
                        <li><a href="#Tokenomic" aria-label="openNav" onClick={() => setNav(!nav)} className='font-chewy text-[18px] font-normal text-black no-underline leading-[100%] after:absolute after:bottom-[-4px] after:left-[50%] after:w-0 after:bg-black after:h-[3px] hover:after:w-full relative after:right-0 hover:after:left-0 after:transition-all after:duration-300 after:rounded-[5px] after:ease-linear'>Tokenomic</a></li>
                        <li><a href="#Roadmap" aria-label="openNav" onClick={() => setNav(!nav)} className='font-chewy text-[18px] font-normal text-black no-underline leading-[100%] after:absolute after:bottom-[-4px] after:left-[50%] after:w-0 after:bg-black after:h-[3px] hover:after:w-full relative after:right-0 hover:after:left-0 after:transition-all after:duration-300 after:rounded-[5px] after:ease-linear'>Roadmap</a></li>
                        <li><a href="#faq" aria-label="openNav" onClick={() => setNav(!nav)} className='font-chewy text-[18px] font-normal text-black no-underline leading-[100%] after:absolute after:bottom-[-4px] after:left-[50%] after:w-0 after:bg-black after:h-[3px] hover:after:w-full relative after:right-0 hover:after:left-0 after:transition-all after:duration-300 after:rounded-[5px] after:ease-linear'>FAQ</a></li>
                        <li className=' flex lg:hidden gap-2 items-center'>
                            <a className=' hover:-translate-y-1 duration-300 rounded-full hover:shadow-[0px_0px_12px_4px_rgba(30,31,31,0.36)]' href="https://twitter.com/i/flow/login" target='_blank' rel='noreferrer' aria-label="Twitter" ><Twitter /></a>
                            <a className=' hover:-translate-y-1 duration-300 rounded-full hover:shadow-[0px_0px_12px_4px_rgba(30,31,31,0.36)]' href="https://discord.com/" target='_blank' rel='noreferrer' aria-label="Discord" ><Discord /></a>
                            <a className=' hover:-translate-y-1 duration-300 rounded-full hover:shadow-[0px_0px_12px_4px_rgba(30,31,31,0.36)]' href="https://www.instagram.com/" target='_blank' rel='noreferrer' aria-label="Instagram" ><Instagram /></a>
                        </li>

            ...
            <div className='flex justify-between items-center py-[10px] lg:pt-[4px] lg:pb-[5.50px] pl-[24px] pr-[7.42px] bg-white rounded-[61.102px] border-b-[4px] border-solid border-black'>
                ...
                <div className='flex gap-[136px] items-center'>
                    <ul className={`${nav ? "left-[-100%]" : "left-0"} flex max-lg:fixed gap-[28px] max-lg:z-50 items-center max-lg:top-0 max-lg:h-full max-lg:w-full max-lg:bg-white max-lg:transition-all max-lg:duration-300 max-lg:ease-linear max-lg:min-h-screen max-lg:flex-col max-lg:justify-center`}>
                        <li><a href="#About" onClick={() => setNav(!nav)} className='font-chewy text-[18px] font-normal text-black no-underline leading-[100%] after:absolute after:bottom-[-4px] after:left-[50%] after:w-0 after:bg-black after:h-[3px] hover:after:w-full relative after:right-0 hover:after:left-0 after:transition-all after:duration-300 after:rounded-[5px] after:ease-linear'>About</a></li>
                        <li><a href="#Tokenomic" onClick={() => setNav(!nav)} className='font-chewy text-[18px] font-normal text-black no-underline leading-[100%] after:absolute after:bottom-[-4px] after:left-[50%] after:w-0 after:bg-black after:h-[3px] hover:after:w-full relative after:right-0 hover:after:left-0 after:transition-all after:duration-300 after:rounded-[5px] after:ease-linear'>Tokenomic</a></li>
                        <li><a href="#Roadmap" onClick={() => setNav(!nav)} className='font-chewy text-[18px] font-normal text-black no-underline leading-[100%] after:absolute after:bottom-[-4px] after:left-[50%] after:w-0 after:bg-black after:h-[3px] hover:after:w-full relative after:right-0 hover:after:left-0 after:transition-all after:duration-300 after:rounded-[5px] after:ease-linear'>Roadmap</a></li>
                        <li><a href="#faq" onClick={() => setNav(!nav)} className='font-chewy text-[18px] font-normal text-black no-underline leading-[100%] after:absolute after:bottom-[-4px] after:left-[50%] after:w-0 after:bg-black after:h-[3px] hover:after:w-full relative after:right-0 hover:after:left-0 after:transition-all after:duration-300 after:rounded-[5px] after:ease-linear'>FAQ</a></li>
